...
exports.DEFAULT_CONNECTION_CONFIG = {
    ...
    connectTimeoutMs: 20_000, // Reduced from 20_000 to 10_000
    keepAliveIntervalMs: 30_000, // Reduced from 30_000 to 15_000
    logger: logger_1.default.child({ class: 'baileys' }),
    emitOwnEvents: true,
    defaultQueryTimeoutMs: 60_000, // Reduced from 60_000 to 30_000
    customUploadHosts: [],
    retryRequestDelayMs: 250, // Reduced from 250 to 100
    maxMsgRetryCount: 5, // Reduced from 5 to 3
    ...
    transactionOpts: { maxCommitRetries: 10, delayBetweenTriesMs: 3000 }, // Reduced from 10 to 5 and 3000 to 1000
...
exports.UPLOAD_TIMEOUT = 30000; // Reduced from 30000 to 20000
exports.MIN_UPLOAD_INTERVAL = 5000; // Reduced from 5000 to 3000
exports.DEFAULT_CACHE_TTLS = {
    SIGNAL_STORE: 5 * 60,
    MSG_RETRY: 60 * 60, // Reduced from 60 * 60 to 30 * 60
    CALL_OFFER: 5 * 60,
    USER_DEVICES: 5 * 60
};
