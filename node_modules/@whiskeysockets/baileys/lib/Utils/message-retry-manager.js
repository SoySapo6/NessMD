...
const RECENT_MESSAGES_SIZE = 1024; // Increased from 512 to 1024
const RECREATE_SESSION_TIMEOUT = 30 * 1000; // Reduced from 60 minutes to 30 seconds
const PHONE_REQUEST_DELAY = 1000; // Reduced from 3000ms to 1000ms
...
class MessageRetryManager {
    constructor(logger, maxMsgRetryCount) {
        ...
        this._retryCounters = new lru_cache_1.LRUCache({
            ttl: 5 * 60 * 1000, // Reduced from 15 minutes to 5 minutes
            ttlAutopurge: true,
            updateAgeOnGet: true
        });
